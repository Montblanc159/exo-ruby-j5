...
def user_action(menu)
  case menu
  when 1
    return num_of_journalists
  when 2
    return num_of_numbers
  when 3
    return check_aude
  when 4
    return check_first_caps
  when 5
    return check_caps
  when 6
  when 7
